...
import {calculateResults} from "../politicialTestCalculator.js";
import "../../Styles/politicialTest.css";
  ...
  constructor() {
    ...
    this.state = {
      ...
      questions: ["Abortion is healthcare.",
                  ...
                  "The richer you are, the bigger taxes you should pay.",
                  "The world should aim to create a world government.",
                  "We should fight with tax havens.",
                  "Same sex marriage should be legal.",
                  "Government should provide houses to homeless people.",
                  "People who are of different religion are not right.",
                  ...
                  "Government should put higher taxes on harmful products such as alcohol or sweets.",
                  ...
                  "Eutanasia should be legal.",
                  "There is nothing wrong with companies which factories in the Third World hire children.",
                  ...
                  "COVID-19 vaccines should be distributed equally in the whole world.",
                  "Government should care more about people of country’s nationality than foreigners living in this country.",
                  "GDP is the best measure of a country’s economic wealth.",
                  "Only people with higher education should be allowed to vote.",
                  ...
                  "Government should promote the nation's traditional values.",
                  "It should be government’s prioritee to fight with social inequalities."],
